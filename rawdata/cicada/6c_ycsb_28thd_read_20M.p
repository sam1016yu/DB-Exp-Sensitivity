...
set pointsize 2
set output '6c_ycsb_28thd_read_20M.eps'
...
set xrange[1:7]
plot '6c_ycsb_28thd_read_20M.dat' using 1:7:xtic(2) ls 1 with linespoints t 'Cicada', '' using 1:8:xtic(2) ls 2 with linespoints t "Silo'",\
