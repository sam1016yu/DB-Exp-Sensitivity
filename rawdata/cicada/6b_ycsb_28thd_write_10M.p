...
set pointsize 3
set output '6b_ycsb_28thd_write_10M.eps'
...
set style line 8   lt 8 lw 7 pt 8 
...
set xrange[1:7]
set yrang[0:4000000]
plot '6b_ycsb_28thd_write_10M.dat' using 1:7:xtic(2) ls 1 with linespoints t 'Cicada',\
 '' using 1:9:xtic(2) ls 2 with linespoints t 'TicToc',\
 '' using 1:12:xtic(2) ls 3 with linespoints t 'Silo',\
 '' using 1:13:xtic(2)ls 4 with linespoints t 'ERMIA',\
 '' using 1:14:xtic(2) ls 5 with linespoints t 'FOEDUS',\
 '' using 1:15:xtic(2) ls 6 with linespoints t 'MOCC'


#plot '6b_ycsb_28thd_write_10M.dat' using 1:7:xtic(2) ls 1 with linespoints t 'Cicada', '' using 1:8:xtic(2) ls 2 with linespoints t "Silo'",\
