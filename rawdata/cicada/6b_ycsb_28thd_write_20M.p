...
set pointsize 2
set output '6b_ycsb_28thd_write_20M.eps'
...
set xrange[1:7]
plot '6b_ycsb_28thd_write_20M.dat' using 1:7:xtic(2) ls 1 with linespoints t 'Cicada', '' using 1:8:xtic(2) ls 2 with linespoints t "Silo'",\
