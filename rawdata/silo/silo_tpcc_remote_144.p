...
set pointsize 3.0
set output 'silo_tpcc_remote_144.eps'
...
set xrange[0:100]
plot 'silo_tpcc_remote_144.dat' using ($3*10):4 ls 1 with linespoints t 'PartitionedStore', '' using ($3*10):5 ls 2 with linespoints t 'MemSilo'
