...
plot 'star_tpcc.dat' using 1:2 ls 1 with linespoints t '48 warehouses', '' using 1:3 ls 3 with linespoints t '96 warehouses (new)',\
 '' using 1:4 ls 2 with linespoints t '192 warehouses (new)', '' using 1:5 ls 4 with linespoints t '240 warehouses (new)'
